-- Fix the ambiguous requested_at reference in 0048.
-- The function signature and behavior are intentionally unchanged.
...
begin
  ...
  insert into public.returns as ret (
    user_id,
    order_id,
    status,
    customer_reason,
  ...
  returning ret.id, ret.requested_at
