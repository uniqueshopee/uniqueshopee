...
const ANDROID_FAQS: HelpFaq[] = [
  ...
  { category: "PAYMENTS", question: "Which payment methods are available?", answer: "Available methods are shown during checkout. Cashfree payments are confirmed by the backend before an order is finalized; Cash on Delivery is handled separately when available." },
