...
const CATEGORY_GROUPS: CategoryGroup[] = [
  {
    ...
    items: [
      { name: "Interior Paint", description: "Beautiful living spaces with a smooth finish.", href: "/category/paints", scene: "living-room" },
      { name: "Exterior Paint", description: "Weather-safe protection for modern homes.", href: "/category/paints", scene: "house" },
      { name: "Primer", description: "Strong base coat essentials.", href: "/category/paints", scene: "bucket" },
      { name: "Wall Putty", description: "Create a clean, polished surface.", href: "/category/paints", scene: "wall" },
      { name: "Waterproofing", description: "Protect roofs and walls from moisture.", href: "/category/paints", scene: "roof" },
      { name: "Paint Accessories", description: "Tools for cleaner, faster jobs.", href: "/category/paints", scene: "tools" },
    ],
  },
  {
    ...
    items: [
      { name: "PVC Pipes", description: "Reliable pipes for everyday supply.", href: "/category/plumbing", scene: "pipes" },
      { name: "CPVC Pipes", description: "Heat-ready piping for installations.", href: "/category/plumbing", scene: "pipes-cold" },
      { name: "Fittings", description: "Secure joints and clean connectors.", href: "/category/plumbing", scene: "fittings" },
      { name: "Faucets", description: "Premium fixtures for daily touchpoints.", href: "/category/plumbing", scene: "faucet" },
      { name: "Valves", description: "Flow control with an industrial look.", href: "/category/plumbing", scene: "valve" },
      { name: "Water Tanks", description: "Storage for steady supply.", href: "/category/plumbing", scene: "tank" },
    ],
  },
];
